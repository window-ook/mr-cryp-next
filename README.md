...
![아키텍처](https://github.com/user-attachments/assets/78fcdee3-8dd8-4a77-a9af-3be74dbe5d81)
...
미스터 크립의 거래:차트 페이지에서 마켓 리스트에 있는 특정 마켓을 선택하면 market(code)을 전역 상태에 저장합니다.<br> 
이 마켓 코드는 차트 페이지에서 나머지 그리드 아이템이자 하위 컴포넌트 요소인<br>
마켓 상세 정보, 차트, 실시간 거래 내역, 실시간 오더북 컴포넌트에서 동기화되어 데이터를 요청합니다.<br>
